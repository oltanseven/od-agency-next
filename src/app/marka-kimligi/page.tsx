...
const deliverables = [
  {
    ...
    title: 'Logo Tasarımı',
    desc: 'Markanızı temsil eden, her ölçekte net görünen, akılda kalan bir logo. Farklı kullanım alanları için varyasyonlar dahil.',
  },
  {
    ...
    title: 'Renk Sistemi',
    desc: 'Markanızın kişiliğini yansıtan ana ve yardımcı renkler. Web, baskı ve sosyal medyada tutarlı görünüm.',
  },
  {
    ...
    title: 'Tipografi',
    desc: 'Başlıklar, alt başlıklar ve gövde metin için uyumlu font sistemi. Okunabilir, modern ve tutarlı.',
  },
  {
    ...
    desc: 'Web siteniz ve sosyal medyanızda tutarlı görsel anlatım. İkon stili, fotoğraf tonu ve illüstrasyon rehberi.',
  },
  {
    ...
    desc: 'Tüm tasarım kurallarını içeren dijital rehber. Ekibiniz veya iş ortaklarınız bu kılavuzu referans alarak tutarlı kalır.',
  },
  {
    ...
    desc: 'Instagram, LinkedIn ve diğer platformlar için hazır tasarım şablonları. Canva veya Figma formatında.',
  },
]
    ...
    <>
      <div className="pt-28 sm:pt-36 pb-14 sm:pb-20 bg-cream-soft border-b border-black/[0.09] relative">
        ...
        <div className="max-w-[1260px] mx-auto px-5 sm:px-8 relative z-10">
          ...
          <h1 className="text-[clamp(2.2rem,5vw,4rem)] font-black leading-[1.08] tracking-[-0.03em] text-ink mb-4">
            Markanız <span className="gradient-text">profesyonel görünsün</span>
          </h1>
          <p className="text-ink/50 text-[1.05rem] max-w-[540px] leading-[1.75]">
            İlk izlenim bir kez yapılır. Logo, renk paleti ve görsel diliniz markanızın gücünü yansıtsın.
          </p>
        </div>
      </div>
      ...
      <section className="py-16 sm:py-28 bg-cream">
        <div className="max-w-[1260px] mx-auto px-5 sm:px-8">
          <div className="mb-14">
            <span className="text-accent text-[0.75rem] font-bold tracking-[0.12em] uppercase mb-3 block">// Teslimatlar</span>
            <h2 className="text-[clamp(1.5rem,3vw,2.2rem)] font-black text-ink">
              Marka kimliği paketinizde <span className="gradient-text">neler var?</span>
            </h2>
          </div>
          ...
          <div className="mt-16 bg-cream-soft border border-black/[0.09] rounded-[20px] px-5 sm:px-10 py-8
            ...
            <div>
              <h3 className="text-[1.2rem] font-bold text-ink mb-1">Markanızı birlikte güçlendirelim</h3>
              <p className="text-ink/50 text-[0.9rem] max-w-[440px]">
                Mevcut görsel kimliğinizi değerlendirelim, ihtiyaçlarınıza uygun bir yol haritası çıkaralım.
              </p>
            </div>
            <Link href="/iletisim"
