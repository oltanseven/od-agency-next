...
export const metadata: Metadata = {
  ...
  description:
    "7/24 kesintisiz müşteri iletişimi. AI chatbot, e-posta otomasyonu, WhatsApp botu ve lead yakalama çözümleri. 15.000₺'den başlayan fiyatlar.",
  keywords: [
    "AI otomasyon",
    "chatbot",
    "e-posta otomasyonu",
  ...
  openGraph: {
    title: "AI Otomasyon Hizmetleri | Chatbot, E-posta, CRM | Oder Agency",
    description:
      "7/24 kesintisiz müşteri iletişimi. AI chatbot, e-posta otomasyonu ve lead yakalama. 15.000₺'den başlayan fiyatlar.",
    ...
    <>
      ...
      <div className="pt-28 sm:pt-36 pb-14 sm:pb-20 bg-cream-soft border-b border-black/[0.09] relative overflow-hidden">
        ...
        <div className="max-w-[1260px] mx-auto px-5 sm:px-8 relative z-10">
          ...
          <p className="text-ink/50 text-[1.05rem] max-w-[540px] leading-[1.75] mb-6">
            Chatbot, WhatsApp asistan, e-posta otomasyonu ve CRM entegrasyonu
            ile müşteri iletişiminizi, satış süreçlerinizi ve raporlamanızı
            otomatikleştirin.
          </p>
          <div className="flex flex-wrap gap-4 text-[0.8rem] font-semibold text-ink/60">
            <span className="bg-white/60 border border-black/[0.06] px-3 py-1.5 rounded-full">
              Yanıt süresi %72 azalır
            </span>
            <span className="bg-white/60 border border-black/[0.06] px-3 py-1.5 rounded-full">
              Rutin görevlerin %50-70&apos;i otomatik
            </span>
            <span className="bg-white/60 border border-black/[0.06] px-3 py-1.5 rounded-full">
              Lead sayısında %84 artış
            </span>
          </div>
        </div>
      </div>
      ...
      <section className="py-16 sm:py-28 bg-cream">
        <div className="max-w-[1260px] mx-auto px-5 sm:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {services.map(({ icon, title, desc, tag }) => (
              ...
              >
                ...
                <p className="text-ink/50 text-[0.88rem] leading-[1.65] mb-3">
                  {desc}
                </p>
          ...
          <div
            className="mt-16 bg-cream-soft border border-black/[0.09] rounded-[20px] px-5 sm:px-10 py-8
            flex flex-col md:flex-row items-center justify-between gap-6"
          >
            <div>
              <h3 className="text-[1.2rem] font-bold text-ink mb-1">
                15.000₺&apos;den başlayan fiyatlarla
              </h3>
              <p className="text-ink/50 text-[0.9rem] max-w-[440px]">
                İş akışınızı analiz edelim, en uygun otomasyon paketini birlikte
                belirleyelim.
              </p>
            </div>
            <Link
